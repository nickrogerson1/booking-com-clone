            ...
            <PopoverGroup className="hidden lg:flex lg:gap-x-12">
                 <Popover className="relative">
                    ...
                    <Transition 
                        ...
                        enterTo="opacity-100 translate-y0"
                        leave="transition ease-in duration-150"
                        leaveFrom="opacity-100 translate-y-0"
                        leaveTo="opacity-0 translate-y-1"
                    >
                        <PopoverPanel className="absolute bg-white -left-8 top-full z-10 mt-3 w-screen
                                ...
                                <div className="p-4">
                                    {products.map(item => (
                                        <div
                                            ...
                                            rounded-lg bg-gray-50 group-hover:bg-gray-200">
                                                <item.icon 
                ...
                <div className="mt-6 flow-root">
                    ...
                    <div className="space-y-2 py-6">
                        <Disclosure as="div" className="-mx-3">
                            {({ open }) => (
                                <>
                                    <DisclosureButton className="flex w-full items-center justify-between rounded-lg
                                    py-2 pl-3 pr-3.5 text-base font-semibold leading-7 text-white hover:bg-blue-800">
                                        Stays
                                        <ChevronDownIcon 
                                            className={cn(
